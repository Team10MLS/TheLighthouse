exports.seed = async function(knex) {
    ...
    await knex('resources').insert([
        ...
        },
        {
          ...
          description: 'Provides general checkups, vaccinations, and minor treatments. Located at 101 Maple Avenue, Anyvillage, USA. Contact Dr. Michael Lee at mlee@example.com or +1 (555) 456-7890.'
        },
        {
          category: 'Support Groups',
          name: 'Mental Health Support Circle',
          description: 'Offers support for mental health issues. Virtual meetings held every Tuesday and Thursday at 7pm. Contact Maria Rodriguez at maria.rodriguez@example.com or +1 (555) 789-0123.'
        },
        {
          category: 'Donation',
          name: 'GiveBack Foundation',
          description: 'Raises funds for providing education to underprivileged children.'
        },
    ]);
  };